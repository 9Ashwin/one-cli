...
// APIError is the typed error for CategoryAPI (catch-all for classified
// platform API business errors). Cause preserves an optional wrapped sentinel
// for errors.Is / errors.Unwrap; it is intentionally not serialized.
...
// Subtype is "challenge_required" or "access_denied"; Code is commonly 21000 or 21001.
