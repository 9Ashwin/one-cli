...
//   - Troubleshooter is the upstream platform's diagnostic URL when the
//     response includes one. Carried universally so any classified error can
//     surface it; populated by framework classifiers when known.
...
// ProblemDetail returns the receiver. It implements the problemCarrier
// interface used by ProblemOf.
